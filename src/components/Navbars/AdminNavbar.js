          ...
          <Nav className="align-items-center d-none d-md-flex" navbar>
            <UncontrolledDropdown nav>
              ...
              <DropdownMenu className="dropdown-menu-arrow" right>
                ...
                <DropdownItem to="/admin/user-profile" tag={Link}><i className="ni ni-single-02" /><span>My profile</span></DropdownItem>
                ...
                <DropdownItem to="/admin/user-profile" tag={Link}><i className="ni ni-support-16" /><span>Support</span></DropdownItem>
